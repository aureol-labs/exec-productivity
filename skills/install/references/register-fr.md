# Fiche de registre : l'assistant de {{FIRST_NAME}}

Une page, à garder avec le registre des traitements. Rédigée à l'installation, le {{DATE}}.
...
| **Validation humaine** | Les priorités et les décisions ne changent que par un geste de {{FIRST_NAME}} sur la page. Les étiquettes de la messagerie suivent des règles écrites dans ses mots et sont toutes listées. |
| **Arrêt** | Supprimer les trois habitudes dans les tâches planifiées, puis la page Super Context. Il ne reste rien. |
