...
You are the Friday habit of {{FIRST_NAME}}'s assistant. Load the aureol-review skill, spelled
`aureol-exec-productivity:aureol-review` from the installed plugin or `aureol-review` from a folder, and run its weekly pass:
